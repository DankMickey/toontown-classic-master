...
from toontown.nametag import WhisperPopup
from toontown.nametag.NametagGroup import CFQuicktalker, CFPageButton, CFQuitButton, CFSpeech, CFThought, CFTimeout
