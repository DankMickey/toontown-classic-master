...
class DistributedLevel(DistributedObject.DistributedObject, Level.Level):
    ...
    def spawnTitleText(self):
        ...
        if description and description != '':
            ...
            if self.lastCamZone not in self.zonesEnteredList:
                ...
                titleSeq = Sequence(Task.Task(self.hideSmallTitleTextTask), Task.Task(self.showTitleTextTask), Wait(0.10000000000000001), Wait(6.0), self.titleText.colorInterval(0.5, Vec4(self.titleColor[0], self.titleColor[1], self.titleColor[2], self.titleColor[3]), Vec4(self.titleColor[0], self.titleColor[1], self.titleColor[2], 0.0)))
            
            smallTitleSeq = Sequence(Task.Task(self.hideTitleTextTask), Task.Task(self.showSmallTitleTask))
    ...
    def showInfoText(self, text = 'hello world'):
        ...
        if description and description != '':
            ...
            """
            titleSeq = None
            titleSeq = Sequence(Task.Task(self.hideSmallTitleTextTask), Task.Task(self.showTitleTextTask), Wait(0.10000000000000001), Wait(3.0), self.titleText.colorInterval(0.5, Vec4(self.titleColor[0], self.titleColor[1], self.titleColor[2], self.titleColor[3]), Vec4(self.titleColor[0], self.titleColor[1], self.titleColor[2], 0.0)))
            if titleSeq:
                seq = Sequence(titleSeq)
