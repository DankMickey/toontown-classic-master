...
class TimeManager(DistributedObject.DistributedObject):
    ...
    def serverTime(self, context, timestamp, timeOfDay):
        ...
        self.attemptCount += 1
        self.notify.info('Clock sync roundtrip took %0.3f ms' % float(elapsed * 1000))
        ...
        if self.talkResult:
            base.localAvatar.setChatAbsolute('latency %0.0f ms, sync \x0c2\x0b1%0.0f ms' % (elapsed * 1000.0, globalClockDelta.getUncertainty() * 1000.0), CFSpeech | CFTimeout)
