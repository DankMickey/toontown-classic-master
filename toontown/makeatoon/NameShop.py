...
#This is here so we can clean names of invalid characters.
...
class NameShop(StateData.StateData):
    ...
    def getNameIndices(self):
        self.nameIndices = string_cleanup(self.nameIndices, special_chars)
        return self.nameIndices

    def getNameFlags(self):
        self.nameFlags = string_cleanup(self.nameFlags, special_chars)
    ...
    def nameIsValid(self, name):
        ...
        name = string_cleanup(name, special_chars)
    ...
    def _updateGuiWithPickAName(self, flags, names, fullName):
        ...
        self.updateCheckBoxes()
        self.updateLists()
        self.names[0] = string_cleanup(self.names[0], special_chars)
