...
class DistributedBuildingMgrAI:
    ...
    def isValidBlockNumber(self, blockNumber):
        return self._DistributedBuildingMgrAI__buildings.has_key(blockNumber)
    ...
    def getToonBlocks(self):
        ...
        for i in self._DistributedBuildingMgrAI__buildings.values():
            if isinstance(i, HQBuildingAI.HQBuildingAI):
                continue
            if isinstance(i, PetshopBuildingAI.PetshopBuildingAI):
                continue 
            if isinstance(i, KartShopBuildingAI.KartShopBuildingAI):
                continue
            if isinstance(i, GagshopBuildingAI.GagshopBuildingAI):
                continue
    ...
    def setFrontDoorPoint(self, blockNumber, point):
        return self._DistributedBuildingMgrAI__buildings[blockNumber].setFrontDoorPoint(point)
