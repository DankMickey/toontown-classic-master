...
PartyEditorGridBounds = ((-0.11, 0.28899999999999998), (0.55000000000000004, -0.44700000000000001))
...
PartyEditorTrashBounds = ((-0.16, -0.38), (-0.050000000000000003, -0.56000000000000005))
...
MutuallyExclusiveActivities = ((ActivityIds.PartyJukebox, ActivityIds.PartyJukebox40), (ActivityIds.PartyValentineJukebox, ActivityIds.PartyValentineJukebox40), (ActivityIds.PartyDance, ActivityIds.PartyDance20), (ActivityIds.PartyValentineDance, ActivityIds.PartyValentineDance20))
...
CogActivityColors = (VBase4(0.22, 0.40000000000000002, 0.97999999999999998, 1.0), VBase4(1.0, 0.42999999999999999, 0.040000000000000001, 1.0))
CogActivitySplatColorBase = VBase4(0.97999999999999998, 0.90000000000000002, 0.094, 1.0)
...
CogActivityLossBeans = int(round(CogActivityBeansToAward * 0.40000000000000002))
...
CogActivityVictoryBarOrangePos = (0.17249999999999999, 0.0, -0.032500000000000001)
