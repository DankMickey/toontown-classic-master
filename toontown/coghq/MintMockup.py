...
class Room(NodePath):
    ...
    MiddleRooms = ('ZONE04a.mb', 'ZONE07a.mb', 'ZONE08a.mb', 'ZONE10a.mb', 'ZONE13a.mb', 'ZONE15a.mb', 'ZONE17a.mb', 'ZONE18a.mb', 'ZONE19a.mb')
    ...
    def showAxes(self):
        ...
        self.axes[-1].setScale(0.59999999999999998)
