...
class DistributedGolfGreenGameAI(BattleBlockerAI.BattleBlockerAI, NodePath, BasicEntities.NodePathAttribs):
    ...
    def startTimer(self):
        ...
        taskMgr.doMethodLater(self.totalTime, self._DistributedGolfGreenGameAI__handleTimeOut, self.taskName('GolfGreenGameTimeout'))
    ...
    def _DistributedGolfGreenGameAI__printTime(self, task):
        ...
        taskMgr.doMethodLater(1.0, self._DistributedGolfGreenGameAI__printTime, self.taskName('GolfGreenGameTimeout Print'))
        return task.done
    ...
    def choosePattern(self):
        ...
        for boardIndex in range(len(self.boardList)):
            ...
            if boardToAssign == None or len(self.boardList[boardIndex][0]) < len(self.boardList[boardToAssign][0]):
                ...
                continue
            if len(self.boardList[boardIndex][0]) == len(self.boardList[boardToAssign][0]):
    ...
    def generate(self):
        ...
        taskMgr.doMethodLater(1.0, self._DistributedGolfGreenGameAI__detect, self.detectName)
