...
ProtectedAnimList = ['Push', 'GolfBadPutt', 'GolfGoodPutt', 'GolfPuttLoop', 'Flattened', 'CatchEating', 'Catching', 'ScientistJealous',
                     'ScientistLessWork', 'ScientistEmcee', 'ScientistWork', 'ScientistPlay', 'Dive', 'GolfRotateRight', 'Flat', 
                     'CogThiefRunning']  
