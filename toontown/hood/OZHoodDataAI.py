...
class OZHoodDataAI(HoodDataAI.HoodDataAI):
    ...
    def startup(self):
        ...
        # TODO: Fix char paths!!!!!
        if simbase.air.config.GetBool('create-chip-and-dale', 0):
    ...
    def _OZHoodDataAI__cycleLeaderBoards(self, task = None):
        ...
        taskMgr.doMethodLater(self.cycleDuration, self._OZHoodDataAI__cycleLeaderBoards, str(self) + '_leaderBoardSwitch')
