...
class Toon(Avatar.Avatar, ToonHead):
    ...
    def startBobSwimTask(self):
        ...
        self.swimBobTask = Sequence(Func(self.swimBobTaskOut), Func(self.swimBobTaskIn))
        self.swimBobTask.start()


    def swimBobTaskOut(self):
        self.getGeomNode().posInterval(0, Vec3(-3, 3, 1), blendType = 'easeInOut')


    def swimBobTaskIn(self):
        self.getGeomNode().posInterval(0, Vec3(-3, 4, 1), blendType = 'easeInOut')
    ...
    def takeOffSuit(self):
        ...
        self.isDisguised = 0
        self.setFont(ToontownGlobals.getToonFont())
        self.nametag.setNameWordWrap(10.0)
        if hasattr(base, 'idTags') and base.idTags:
            name = self.getAvIdName()
        else:
            name = self.getName()
