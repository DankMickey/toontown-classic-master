...
class ToontownMagicWordManager(MagicWordManager.MagicWordManager):
    ...
    def doMagicWord(self, word, avId, zoneId):
        ...
        if wordIs('~sf'):
        ...
        elif wordIs('~collisions_on') or wordIs('~collisionsOn') or wordIs('~con'):
            base.localAvatar.collisionsOn()
        elif wordIs('~collisions_off') or wordIs('~collisionsOff') or wordIs('~coff'):
            ...
            base.localAvatar.setHp(1)
            #base.localAvatar.setHp(word[:len('~setHp') + 1])
        elif wordIs('~sync'):
