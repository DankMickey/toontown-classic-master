...
class OptionsTabPage(DirectFrame):
    ...
    def __init__(self, parent = aspect2d):
        ...
        DirectFrame.__init__(self, parent, relief = None, pos = (0.0, 0.0, 0.0), scale = (1.0, 1.0, 1.0))
        #self.parent = parent
        self.load()
    ...
    def load(self):
        ...
        if wantShaders:
            self.VisualEffect_Label = DirectLabel(parent = self, relief = None, text = 'Visual Effect', text_align = TextNode.ALeft, text_scale = options_text_scale, text_wordwrap = 10, pos = (leftMargin, 0, textStartHeight - 7 * textRowHeight))
        ...
        if wantShaders:
            self.visualEffectLeftArrow = DirectButton(parent = self, relief = None, image = (gui.find('**/Horiz_Arrow_UP'), gui.find('**/Horiz_Arrow_DN'), gui.find('**/Horiz_Arrow_Rllvr'), gui.find('**/Horiz_Arrow_UP')), image3_color = Vec4(1, 1, 1, 0.5), scale = (-1.0, 1.0, 1.0), pos = (0.25, 0, buttonbase_ycoord - textRowHeight * 7), command = self._OptionsTabPage__doVisualEffectLeft)
            self.visualEffectRightArrow = DirectButton(parent = self, relief = None, image = (gui.find('**/Horiz_Arrow_UP'), gui.find('**/Horiz_Arrow_DN'), gui.find('**/Horiz_Arrow_Rllvr'), gui.find('**/Horiz_Arrow_UP')), image3_color = Vec4(1, 1, 1, 0.5), pos = (0.65000000000000002, 0, buttonbase_ycoord - textRowHeight * 7), command = self._OptionsTabPage__doVisualEffectRight)
        else:
        ...
        if wantShaders:
            self.visualEffectText = SpeedChat.SpeedChat(name = 'OptionsPageStyleText', structure = [
                2000], backgroundModelName = 'phase_3/models/gui/ChatPanel', guiModelName = 'phase_3.5/models/gui/speedChatGui')
            self.visualEffectText.setScale(self.speed_chat_scale)
            self.visualEffectText.setPos(0.37, 0, (buttonbase_ycoord - textRowHeight * 7) + 0.029999999999999999)
    ...
    def updateVisualEffect(self):
        ...
        self.visualEffectText.setPos(0.44500000000000001 - self.visualEffectText.getWidth() * self.speed_chat_scale / 2, 0, self.visualEffectText.getPos()[2])
        if self.visualEffectIndex > 0:
