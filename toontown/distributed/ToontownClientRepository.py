...
class ToontownClientRepository(OTPClientRepository.OTPClientRepository):
    ...
    def enterChooseAvatar(self, avList):
        ...
        self.pickChooseAvatar(avList)

    def pickChooseAvatar(self, avList):
        self.avChoiceDoneEvent = 'avatarChooserDone'
        klass = NewPickAToon.NewPickAToon if Settings.getEnablePat3d() else AvatarChooser.AvatarChooser
        if not self.isPaid():
