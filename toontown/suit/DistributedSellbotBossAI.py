...
class DistributedSellbotBossAI(DistributedBossCogAI.DistributedBossCogAI, FSM.FSM):
    ...
    def enterRollToBattleTwo(self):
        self.divideToons()
        self.barrier = self.beginBarrier('RollToBattleTwo', self.involvedToons, 45, self._DistributedSellbotBossAI__doneRollToBattleTwo)
    ...
    def enterPrepareBattleTwo(self):
        self.barrier = self.beginBarrier('PrepareBattleTwo', self.involvedToons, 30, self._DistributedSellbotBossAI__donePrepareBattleTwo)
    ...
    def enterPrepareBattleThree(self):
        self.barrier = self.beginBarrier('PrepareBattleThree', self.involvedToons, 30, self._DistributedSellbotBossAI__donePrepareBattleThree)
    ...
    def _DistributedSellbotBossAI__saySomethingLater(self, delayTime = 15):
        ...
        taskMgr.remove(taskName)
        taskMgr.doMethodLater(delayTime, self._DistributedSellbotBossAI__saySomething, taskName)
    ...
    def enterVictory(self):
        ...
        self.barrier = self.beginBarrier('Victory', self.involvedToons, 10, self._DistributedSellbotBossAI__doneVictory)
