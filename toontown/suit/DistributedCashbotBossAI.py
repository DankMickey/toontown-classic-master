...
class DistributedCashbotBossAI(DistributedBossCogAI.DistributedBossCogAI, FSM.FSM):
    ...
    def grabAttempt(self, avId, treasureId):
        ...
        if treasure:
            if treasure.validAvatar(av):
                ...
                taskMgr.doMethodLater(5, self._DistributedCashbotBossAI__recycleTreasure, treasure.uniqueName('recycleTreasure'), extraArgs = [
                    treasure])
            else:
    ...
    def waitForNextHelmet(self):
        ...
        if currState == 'BattleThree':
            ...
            taskMgr.doMethodLater(delayTime, self._DistributedCashbotBossAI__donHelmet, taskName)
    ...
    def enterPrepareBattleThree(self):
        ...
        self._DistributedCashbotBossAI__makeBattleThreeObjects()
        self._DistributedCashbotBossAI__resetBattleThreeObjects()
        self.barrier = self.beginBarrier('PrepareBattleThree', self.involvedToons, 55, self._DistributedCashbotBossAI__donePrepareBattleThree)
    ...
    def enterBattleThree(self):
        ...
        taskName = self.uniqueName('NextGoon')
        taskMgr.remove(taskName)
        taskMgr.doMethodLater(2, self._DistributedCashbotBossAI__doInitialGoons, taskName)
    ...
    def enterVictory(self):
        ...
        self.barrier = self.beginBarrier('Victory', self.involvedToons, 30, self._DistributedCashbotBossAI__doneVictory)
