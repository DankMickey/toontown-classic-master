...
class DistributedCashbotBossGoonAI(DistributedGoonAI.DistributedGoonAI, DistributedCashbotBossObjectAI.DistributedCashbotBossObjectAI):
    ...
    def _DistributedCashbotBossGoonAI__startWalk(self):
        ...
        if availableTime > 0:
            ...
            taskMgr.doMethodLater(availableTime, self._DistributedCashbotBossGoonAI__reachedTarget, self.uniqueName('reachedTarget'))
            self.isWalking = 1
        else:
    ...
    def enterEmergeA(self):
        ...
        taskMgr.doMethodLater(walkTime, self._DistributedCashbotBossGoonAI__recoverWalk, self.uniqueName('recoverWalk'))
    ...
    def enterRecovery(self):
        ...
        taskMgr.doMethodLater(2.0, self._DistributedCashbotBossGoonAI__recoverWalk, self.uniqueName('recoverWalk'))
